...
class CChanConfig:
    ...
    def set_bsp_config(self, conf):
        para_dict = {
            ...
            "macd_algo": "area_full_ext",       # MACD背驰计算；first-to-peak：第一根同向柱→笔内|macd|全局最大峰值同向柱区间面积之和（峰值之后不计；见 Bi.Bi.Cal_MACD_area_full_ext / Common.CEnum MACD_ALGO.AREA_FULL_EXT）
