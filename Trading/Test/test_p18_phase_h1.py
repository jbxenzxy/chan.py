...
# ════════════════════════════════════════════════════════════════
print("\n[1] E2E：BUY 开仓 → LOCK → 留双向持仓（原仓+反向 LOCKED，不兑现 PnL）")
with tmp_dir() as tmp:
...
with tmp_dir() as tmp:
    ...
    check("[4b] 双向持仓 entry_mode=LOCKED",
