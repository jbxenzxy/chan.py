...
from BuySellPoint.BSPointList import CBSPointList, CMyBSPointList
...
class CKLine_List:
    def __init__(self, kl_type, conf: CChanConfig, code: str = "", market_type: str = None):
        ...
        self.bs_point_lst = CMyBSPointList[CBi, CBiList](bs_point_config=conf.bs_point_conf)  # 自定义买卖点（继承自 CBSPointList）
    ...
    def cal_seg_and_zs(self):
        ...
        self.bs_point_lst.cal(self.bi_list, self.zs_list)  # 笔买卖点（CMyBSPointList → cal_bs0point/1/2/3）
